  ...
  return (
    <section id="doctor" className="py-20 md:py-28 bg-white border-t border-[#E5E2DD]" aria-label="Meet the Doctor">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center bg-[#FAF9F7] rounded-3xl border border-[#E5E2DD] p-6 sm:p-10 lg:p-12 shadow-xs">
          
          {/* Doctor Portrait / Monogram Visual */}
          <div className="lg:col-span-5 flex justify-center">
            <div className="w-full max-w-sm">
              <div className="relative rounded-2xl overflow-hidden border border-[#E5E2DD] bg-white shadow-sm aspect-[4/5] flex items-center justify-center">
                {hasPhoto ? (
                  <img
                    src={doctor.photo || ''}
                  ...
                  /* Refined Monogram / Initial Visual (Never a fake stock face) */
                  <div className="w-full h-full flex flex-col items-center justify-center p-8 bg-gradient-to-b from-white to-[#FAF9F7] text-center">
                    <div className="w-24 h-24 rounded-2xl bg-[#7C9885]/10 border border-[#7C9885]/20 flex items-center justify-center text-[#7C9885] font-editorial text-3xl font-semibold mb-4 shadow-xs">
                      {initials || 'DR'}
                    </div>
                    <h3 className="font-editorial text-2xl text-[#1A1A1A] font-medium">
                      {doctor.name}
                    </h3>
                    <p className="text-xs text-[#5C5C5C] mt-1 uppercase tracking-wider font-semibold">
                      {doctor.specialty}
                    </p>
                    <div className="w-10 h-px bg-[#E5E2DD] my-4" />
          ...
          <div className="lg:col-span-7 space-y-6">
            <div>
              ...
              <p className="text-sm font-medium text-[#5C5C5C] mt-1">
                {doctor.specialty}
              </p>
            </div>
            ...
            <div className="pt-2 border-t border-[#E5E2DD] grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-[#5C5C5C]">
            ...
            <div className="pt-4">
              <button
                onClick={onBookClick}
                className="inline-flex items-center space-x-2 px-6 py-3 bg-[#1A1A1A] hover:bg-[#7C9885] text-white text-xs uppercase tracking-widest font-semibold rounded-full transition-all duration-200 cursor-pointer shadow-xs"
              >
